...
with open('temp2.csv', 'w', newline='') as outputfile2:
    ...
    writer2.writerow(['Transaction Type', 'Date', 'Source', 'Fund Name', 'Unit Count', 'Unit Value',
                      'Transaction Amount', 'Investment Action', 'Ticker'])
    ...
    for row in reader2:
        ...
        if 'American Century Equity Income R6' == row[3]:
            ...
            row[3] = row[3].replace('American Funds EuroPacific Gr R5',
                                    'American Funds EuroPacific Growth Fund® Class R-5')
            writer2.writerow(row)

        elif 'American Funds EuroPacific Gr R6' == row[3]:
            row.append(str('RERGX'))
            row[3] = row[3].replace('American Funds EuroPacific Gr R6',
                                    'American Funds EuroPacific Growth Fund Class R-6')
            writer2.writerow(row)

        elif 'American Funds EuroPacific Growth R5E' == row[3]:
            row.append(str('RERHX'))
            row[3].replace('American Funds EuroPacific Growth R5E',
                           'American Funds EuroPacific Growth Fund® Class R-5E')
            writer2.writerow(row)

        elif 'American Funds Inflation Linked Bond R-6' == row[3]:
            row.append(str('RILFX'))
            row[3] = row[3].replace('American Funds Inflation Linked Bond R-6',
            ...
            row[3] = row[3].replace('BlackRock Inflation Protected Bond Instl',
            ...
            row[3] = row[3].replace('Delaware Emerging Markets Instl',
            ...
            row[3] = row[3].replace('JHancock International Growth R6',
            ...
            row[3] = row[3].replace('Metropolitan West Total Return Bond Plan',
            ...
            row[3] = row[3].replace('Vanguard Institutional Index I',
                                    'Vanguard Institutional Index Fund Institutional Shares')
            writer2.writerow(row)

        elif 'Vanguard Interm-Term Bond Index Adm' == row[3]:
            row.append(str('VBILX'))
            row[3] = row[3].replace('Vanguard Interm-Term Bond Index Adm',
                                    'Vanguard Intermediate-Term Bond Index Fund Admiral Shares')
            writer2.writerow(row)

        elif 'Vanguard Interm-Term Bond Index I' == row[3]:
            row.append(str('VBIMX'))
            row[3] = row[3].replace('Vanguard Interm-Term Bond Index I',
            ...
            row[3] = row[3].replace('Vanguard Total Intl Stock Index Admiral',
...
with open('transactions_final.csv', 'w', newline='') as outputfile3:
    ...
    writer3.writerow(['Transaction Type', 'Date', 'Source', 'Fund Name', 'Unit Count', 'Unit Value',
                      'Transaction Amount', 'Investment Action', 'Ticker'])
